		...
		<div className="relative w-full h-full flex flex-col group">
			<div className="flex items-center justify-between px-1 pb-2 shrink-0">
				...
				<button
					...
					className="p-1.5 bg-slate-800/80 hover:bg-emerald-500/20 text-slate-400 hover:text-emerald-400 rounded-md opacity-0 group-hover:opacity-100 transition-all shadow-sm border border-transparent hover:border-emerald-500/30"
